...
def _build_hub_components(self_root: str, hub_id: str) -> dict:
    ...
    return {
        ...
        "cleanup_orphaned_sensors": {
            "platform": "button",
            "name": "Cleanup orphaned sensors",
            "entity_category": "config",
            "command_topic": f"{self_root}/hub/{hub_id}/cleanup_orphaned_sensors",
            "payload_press": "cleanup",
        },
        "remote_pair": {
            "platform": "button",
        ...
        "paired_sensors": {
            "platform": "sensor",
            "name": "Paired sensors",
            "state_topic": f"{self_root}/hub/{hub_id}/paired_sensors",
            "state_class": "measurement",
        ...
        "configured_sensors": {
            ...
            "state_topic": f"{self_root}/hub/{hub_id}/configured_sensors",
            "state_class": "measurement",
        ...
        "orphan_retention": {
            "platform": "number",
            "name": "Orphan retention",
            "entity_category": "config",
            "state_topic": f"{self_root}/hub/{hub_id}/orphan_retention_days",
            "command_topic": f"{self_root}/hub/{hub_id}/orphan_retention_days/set",
            "min": 0,
            "max": 365,
            "step": 1,
            "mode": "box",
